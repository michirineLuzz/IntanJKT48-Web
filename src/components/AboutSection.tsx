...
const PencakSilatIcon = ({ className }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    {/* Martial arts pose - simplified figure */}
    {/* Head */}
    <circle cx="12" cy="5" r="2" />
    {/* Body */}
    <line x1="12" y1="7" x2="12" y2="13" />
    {/* Left arm (raised/attacking) */}
...
// Custom Performing Icon (Person on stage with spotlight)
const PerformingIcon = ({ className }: { className?: string }) => (
  ...
  >
    ...
    {/* Left arm up (performing gesture) */}
...
const AboutSection = () => {
  ...
  const milestones = [
    { year: "2024", title: "Joined JKT48", desc: "Became part of 13th Generation at 31.10.2024" },
    { year: "2025", title: "Shonichi Show (Ingin Bertemu)", desc: "Debut on theater stage at 26.01.2025" },
    { year: "2025", title: "Shonichi Video Call", desc: "Her Shonichi video call was on 23.03.2025." },
    { year: "2025", title: "Shonichi Pajama Drive", desc: "Shonichi Pajama Drive was on 03.05.2025." },
    { year: "2025", title: "Shonichi Off Air Concert", desc: "Shonichi Off Air Concert was on 29.06.2025." },
    { year: "2025", title: "Shonichi Kira-kira Girls", desc: "Shonichi Kira-kira Girls was on 21.11.2025." },
    { year: "2025", title: "Shonichi Backdancer Appearance", desc: "Her Shonichi backdancer appearance in JKT48 5th Stage for the Glory days song was on October 19, 2025." },
  ];
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { title: "Oldest Gen 13", desc: "The oldest member of JKT48's 13th Generation" },
              { title: "Original Ace", desc: "Original ace of JKT48's 13th Generation" },
              { title: "Multi-Talented", desc: "Before joining JKT48, she was a pencak silat athlete and dancer" },
              { title: "Silat Champion", desc: "Representing Sabda Sunda Silat School, won 1st place in Pusaka Sunda Cup Jabodetabek (July 10, 2022)" },
              { title: "Dance Competitor", desc: "Participated in DBL Dance Competition 2023 - West Java Series representing SMAN 3 Bogor" },
              { title: "Cover Dancer", desc: "Before joining JKT48, she often did JKT48 dance covers with friends on campus" },
              { title: "UI Student", desc: "Currently studying Creative Advertising at Universitas Indonesia, class of 2024" },
              { title: "Childhood Star", desc: "Appeared in JKT48's YouTube video 'Dance Class for Kids' (Feb 2016) when she was 9 years old" },
              { title: "Persistent Dreamer", desc: "After multiple audition attempts (Gen 10, 11, 12, KLP48), she finally passed JKT48's 13th Generation audition in 2024" },
              { title: "Ukulele Player", desc: "Intan is skilled at playing the ukulele, so she often covers songs." },
            ].map((fact, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, y: 30, scale: 0.9 }}
        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            {[
              { tag: "#SenINTAN", label: "Every Monday", emoji: "🌅" },
              { tag: "#JumaTAN", label: "Every Friday", emoji: "✨" },
              { tag: "#NighTAN", label: "Before Bed", emoji: "🌙" },
              { tag: "#kataINTAN", label: "Quotes", emoji: "💭" },
              { tag: "#dancINTAN", label: "Dance Cover", emoji: "💃" },
              { tag: "#intanraksi", label: "Video Call", emoji: "📱" },
            ].map((item, index) => (
              <motion.div
                key={index}
                initial={{ opacity: 0, scale: 0.8, y: 20 }}
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
              ...
              >
                ...
                <p className="text-emerald-600 dark:text-emerald-400 font-bold">#sanTAN</p>
                <p className="text-muted-foreground text-xs mt-1">Every Sahur</p>
              </motion.div>
              <motion.div
                whileHover={{ y: -3, scale: 1.03 }}
                className="bg-white/80 dark:bg-zinc-900/80 rounded-xl p-4 text-center shadow-md border border-emerald-200/50 dark:border-emerald-800/30"
              >
                ...
                <p className="text-emerald-600 dark:text-emerald-400 font-bold">#bukberIN</p>
                <p className="text-muted-foreground text-xs mt-1">Every Iftar</p>
              </motion.div>
            </div>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="text-center mb-12">
            ...
            >
              <span className="text-4xl md:text-5xl font-bold">44</span>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <motion.div
              ...
              whileHover={{ y: -10, scale: 1.02 }}
              className="bg-gradient-to-br from-white to-rose-50 dark:from-zinc-900 dark:to-rose-900/10 rounded-2xl overflow-hidden shadow-lg border border-rose-200/50 dark:border-rose-800/30 hover:shadow-xl transition-all cursor-pointer"
            >
              <div className="bg-gradient-to-r from-rose-500 to-pink-500 p-4">
                <h3 className="text-white font-bold text-lg">JKT48 TN3</h3>
                <p className="text-white/80 text-sm">Aitakatta</p>
              </div>
              <div className="p-5 space-y-3">
                {["Nageki no Figure", "Koi no PLAN", "Senaka Kara Dakishimete"].map((song, i) => (
            ...
            <motion.div
              ...
              whileHover={{ y: -10, scale: 1.02 }}
              className="bg-gradient-to-br from-white to-violet-50 dark:from-zinc-900 dark:to-violet-900/10 rounded-2xl overflow-hidden shadow-lg border border-violet-200/50 dark:border-violet-800/30 hover:shadow-xl transition-all cursor-pointer"
            >
              <div className="bg-gradient-to-r from-violet-500 to-purple-500 p-4">
                <h3 className="text-white font-bold text-lg">JKT48 TN1</h3>
                <p className="text-white/80 text-sm">Pajama Drive</p>
              </div>
              <div className="p-5 space-y-3">
                {["Pajama Drive", "Kagami no Naka no Jean Da Arc"].map((song, i) => (
                  <div key={i} className="flex items-center gap-3">
            ...
            <motion.div
              ...
              whileHover={{ y: -10, scale: 1.02 }}
              className="bg-gradient-to-br from-white to-amber-50 dark:from-zinc-900 dark:to-amber-900/10 rounded-2xl overflow-hidden shadow-lg border border-amber-200/50 dark:border-amber-800/30 hover:shadow-xl transition-all cursor-pointer"
            >
              <div className="bg-gradient-to-r from-amber-500 to-orange-500 p-4">
                <h3 className="text-white font-bold text-lg">JKT48 TN SS1</h3>
                <p className="text-white/80 text-sm">Kira Kira Girls</p>
              </div>
              <div className="p-5 space-y-3">
                {["Candy"].map((song, i) => (
                  <div key={i} className="flex items-center gap-3">
