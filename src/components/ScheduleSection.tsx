      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="relative">
            ...
            <motion.div
              className="absolute left-0 md:left-1/2 transform md:-translate-x-1/2 w-1 h-full bg-gradient-to-b from-primary via-purple via-gold to-primary/30 origin-top rounded-full"
              initial={{ scaleY: 0 }}
            ...
            {scheduleEvents.map((event, index) => {
              ...
              return (
                ...
                >
                  ...
                  <motion.div
                    className="absolute left-0 md:left-1/2 transform -translate-x-1/2 w-6 h-6 rounded-full bg-gradient-to-br from-primary via-purple to-gold border-4 border-background shadow-glow z-10"
                    initial={{ scale: 0 }}
                    whileInView={{ scale: 1 }}
                    viewport={{ once: true }}
                  ...
                  <div className={`ml-8 md:ml-0 md:w-1/2 ${index % 2 === 0 ? "md:pr-12" : "md:pl-12"}`}>
                    <motion.div
                      ...
                      className={`glass-card p-6 relative overflow-hidden ${event.featured ? "ring-2 ring-primary/40 shadow-glow" : ""}`}
                    >
